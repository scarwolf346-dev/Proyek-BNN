                                ...
                                if(mysqli_num_rows($query) > 0){
                                    ...
                                    if($_SESSION['username'] == $row['username']){
                                        ...
                                        if($row['admin'] == 1){
                                          ...
                                          echo ' <a class="btn small blue waves-effect waves-light" href="?page=sett&sub=usr&act=edit&admin='.$row['admin'].'">
                                                 <i class="material-icons">edit</i> EDIT</a>
                                                 <a class="btn small deep-orange waves-effect waves-light" href="?page=sett&sub=usr&act=del&admin='.$row['admin'].'"><i class="material-icons">delete</i> DEL</a>';
                                        }
                                    } echo '</td>
                                    </tr>
                                </tbody>';
