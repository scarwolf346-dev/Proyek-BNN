            ...
            <div class="col s12 m6 offset-m3 offset-m3">
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <form class="col s12 m12 offset-4 offset-4" method="POST" action="" >
                       ...
                       <div>
                    <button type="submit" class="btn btn-primary col s12" name="submit" >Masuk</button> 
                    <a href="index.php"><button type="button" class="btn btn-success col s12">Halaman Utama</button></a>
