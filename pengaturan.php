        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['sub'])){
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    if ($_REQUEST['nama'] == "" || $_REQUEST['status'] == "" || $_REQUEST['alamat'] == "" || $_REQUEST['karo'] == "" || $_REQUEST['nip'] == ""
                            ...
                            echo '<script language="javascript">window.history.back();</script>';
                                ...
                                if(!preg_match("/^[a-zA-Z0-9.,:\/<> -\"]*$/", $status)){
                                    ...
                                    if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $alamat)){
                                        ...
                                        if(!preg_match("/^[a-zA-Z., ]*$/", $karo)){
                                            $_SESSION['karo'] = 'Form Nama Kepala Biro hanya boleh mengandung karakter huruf, spasi, titik(.) dan koma(,)<br/><br/>';
                                            echo '<script language="javascript">window.history.back();</script>';
                                        } else {

                                            if(!preg_match("/^[0-9 -]*$/", $nip)){
                                                $_SESSION['nipkaro'] = 'Form NIP Kepala Biro hanya boleh mengandung karakter angka, spasi, dan minus(-)<br/><br/>';
                                                echo '<script language="javascript">window.history.back();</script>';
                                            } else {
                                                        ...
                                                        if(!empty($logo)){
                                                            ...
                                                            if(in_array($eks, $ekstensi) == true){
                                                                if($ukuran < 2000000){
                                                                    ...
                                                                    $query = mysqli_query($config, "UPDATE tbl_instansi SET nama='$nama',status='$status',alamat='$alamat',karo='$karo',nip='$nip',website='$website',email='$email',logo='$nlogo',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_instansi SET nama='$nama',status='$status',alamat='$alamat',karo='$karo',nip='$nip',website='$website',email='$email',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                            ...
                            <form class="col s12" method="post" action="?page=sett" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="karo" type="text" class="validate" name="karo" value="<?php echo $row['karo']; ?>" required>
                                            <?php
                                                if(isset($_SESSION['karo'])){
                                                    $karo = $_SESSION['karo'];
                                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$karo.'</div>';
                                                    unset($_SESSION['karo']);
                                                }
                                            ?>
                                        <label for="karo">Nama Kepala Biro</label>
                                    </div>
                                    <div class="input-field col s6">
                                    ...
                                    <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Jika  belum memiliki NIP, isi dengan minus(-)">
                                        ...
                                        <input id="nip" type="text" class="validate" name="nip" value="<?php echo $row['nip']; ?>" required>
                                            <?php
                                                if(isset($_SESSION['nipkaro'])){
                                                    $nipkaro = $_SESSION['nipkaro'];
                                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$nipkaro.'</div>';
                                                    unset($_SESSION['nipkaro']);
                                                }
                                            ?>
                                        <label for="nip">NIP Kepala Biro</label>
                                    </div>
                                    <div class="input-field col s6">
